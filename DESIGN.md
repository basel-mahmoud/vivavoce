...
### Semantic
- **Pass Green** (#2c7a4b): success only, as a fill carrying paper (5.04:1), such as the waitlist confirmation badge. It is not a text colour on themed surfaces: on `card-2` it reads 4.25:1 by day and 2.97:1 at night.
...
- **Mobile:** a 44px menu button opens a tile sheet of display-voice links (1.6rem, current page vermilion) and a full-width primary button. Focus moves to the first link; Escape closes the sheet and returns focus.
...
- **Panel:** five examiners, left to right Correctness, Clarity, Structure, Conciseness and Confidence, each a capsule body and sphere head with its own silhouette and clay: ink (#2b2723, #80776c at night), butter with a bun (#ffc838), porcelain and tallest (#eeeae2), stone with glasses (#c9c4bb), and cobalt, the smallest (#3347ff, #4a5cff at night). Heads turn to follow the camera; they blink and breathe.
- **Focus:** the examiner in focus rises, leans in and swells 5% while its clay warms to vermilion; the others step back, shrink 3% and fade up to 62% toward the floor colour (#e4e1da by day, #3b3631 at night).
